"""
Django settings for MobileSensorCloud project.
...
SECRET_KEY = 'db34ya1ouxl)4v1v&tp3^8-r6u1+2%iad(@+=nakxfeh$a1&6_'
...
ROOT_URLCONF = 'MobileSensorCloud.urls'
...
WSGI_APPLICATION = 'MobileSensorCloud.wsgi.application'
